...
public class UsuarioService {
    ...
    public UserDTO register(SignupDTO request) {
        log.info(Constants.LOG_KEY_MESSAGE + Constants.LOG_KEY_CLASS + Constants.LOG_KEY_METHOD ,
                Constants.LOG_MSG_START_REGISTER_USER, Constants.LOG_CLASS_USER_SERVICE, Constants.LOG_METHOD_REGISTER);
    ...
    public JwtDTO authenticate(LoginDTO request) {
        log.info(Constants.LOG_KEY_MESSAGE + Constants.LOG_KEY_CLASS + Constants.LOG_KEY_METHOD ,
                Constants.LOG_MSG_START_AUTHENTICATE_USER, Constants.LOG_CLASS_USER_SERVICE, Constants.LOG_METHOD_AUTHENTICATE);
